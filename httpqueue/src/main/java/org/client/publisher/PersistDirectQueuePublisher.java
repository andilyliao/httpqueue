...
import org.client.publisher.util.queueconfig.PersistDirectQueueConfig;
 ...
 */
//
public class PersistDirectQueuePublisher extends Publish implements IPublisher {
    private static Logger log = Logger.getLogger(MemoryDirectQueuePublisher.class);
    private Config config;
    private PersistDirectQueueConfig queueConfig;
    ...
    public CommonRes createDirectQueue(PersistDirectQueueConfig queueConfig) throws Exception {
        ...
        String json = "{\"head\":{\"qn\":\""+queueName+"\",\"ty\":0,\"m\":0,\"t\":"+ttl+",\"h\":1}}";
...
//curl http://localhost:8844/queue -d '{"head":{"qn":"mydirectqueue","ty":1,"h":0,"tr":0,"s":0,"ts":0},"body":{"aaa":"bbb","ccc":"ddd"}}'
    ...
    public void initQueueWithoutCreate(PersistDirectQueueConfig queueConfig)throws Exception {
        this.queueConfig=queueConfig;
    }
}
